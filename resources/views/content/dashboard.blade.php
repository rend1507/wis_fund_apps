                    ...
                    <div class="card-body">
                        ...
                        <div class="direct-chat-messages">
                            ...
                            <div class="direct-chat-msg">
                                <div class="direct-chat-infos clearfix"> <span class="direct-chat-name float-start">
                                    ...
                                    src="<?=url("/")?>/assets/img/user1-128x128.jpg" alt="message user image">
                                <!-- /.direct-chat-img -->
                            ...
                            <div class="direct-chat-msg end">
                                <div class="direct-chat-infos clearfix"> <span class="direct-chat-name float-end">
                                    ...
                                    src="<?=url("/")?>/assets/img/user3-128x128.jpg" alt="message user image">
                                <!-- /.direct-chat-img -->
                                <div class="direct-chat-text">
                        ...
                        <div class="direct-chat-contacts">
                            <ul class="contacts-list">
                                <li> <a href="#"> <img class="contacts-list-img" src="<?=url("/")?>/assets/img/user1-128x128.jpg"
                                            alt="User Avatar">
                                ...
                                <li> <a href="#"> <img class="contacts-list-img" src="<?=url("/")?>/assets/img/user7-128x128.jpg"
                                            alt="User Avatar">
                                        <div class="contacts-list-info"> <span class="contacts-list-name">
                                                Sarah Doe
                                                <small class="contacts-list-date float-end">
                                ...
                                <li> <a href="#"> <img class="contacts-list-img" src="<?=url("/")?>/assets/img/user3-128x128.jpg"
                                            alt="User Avatar">
                                        <div class="contacts-list-info"> <span class="contacts-list-name">
                                                Nadia Jolie
                                                <small class="contacts-list-date float-end">
                                ...
                                <li> <a href="#"> <img class="contacts-list-img" src="<?=url("/")?>/assets/img/user5-128x128.jpg"
                                            alt="User Avatar">
                                        <div class="contacts-list-info"> <span class="contacts-list-name">
                                                Nora S. Vans
                                                <small class="contacts-list-date float-end">
                                ...
                                <li> <a href="#"> <img class="contacts-list-img" src="<?=url("/")?>/assets/img/user6-128x128.jpg"
                                            alt="User Avatar">
                                        <div class="contacts-list-info"> <span class="contacts-list-name">
                                                John K.
                                                <small class="contacts-list-date float-end">
                                ...
                                <li> <a href="#"> <img class="contacts-list-img" src="<?=url("/")?>/assets/img/user8-128x128.jpg"
                                            alt="User Avatar">
                                        <div class="contacts-list-info"> <span class="contacts-list-name">
                                                Kenneth M.
                                                <small class="contacts-list-date float-end">
